...
def main():
    ...
    # Search for users in Berlin with >100 followers
...
This repository contains data about GitHub users in Berlin with over 100 followers and their repositories.

## Files

1. `users.csv`: Contains information about {len(users)} GitHub users in Berlin with over 100 followers
